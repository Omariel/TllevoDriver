...
class ClienteChat extends StatefulWidget {
  ClienteChat({Key? key, required this.myEmail, required this.hisEmail,
  required this.hisName}) : super(key: key);
  String myEmail;
  String hisEmail;
  String hisName;
  @override
  State<ClienteChat> createState() => _ClienteChatState();
}

class _ClienteChatState extends State<ClienteChat> {
                  ...
                  ElevatedButton(
                    onPressed: () {
                      sendMessagee(widget.myEmail, 'User',
                          controller.text, widget.hisEmail);
                      controller.clear();
                    },
                    style: ButtonStyle(
